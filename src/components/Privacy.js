  ...
  return (
    <div className="jumbotron">
      ...
      <p>
        ...
        you use our Service. We will not use or share your information with anyone except as described in this Privacy
        Policy. We use your Personal Information for providing and improving the Service. By using the Service, you
      ...
      <p>
        ...
        be used to contact or identify you. Personally identifiable information (“Personal Information”) may include,
        but is not limited to: email, password, maxTargetTemp and Temperature to set
      </p>
      <h3>Log Data</h3>
      <p>
      ...
      <p>
        ...
        means to protect your Personal Information, we cannot guarantee its absolute security. Please remember your
        password is stored in plain text if you chose to use this service.
      </p>
      ...
      <p>
        ...
        operation of this Application (administration, sales, marketing, legal, system administration) or external
      ...
      <ul>
        <li>
          ...
          be allowed to process Personal Data until the User objects to such processing (“opt-out”), without having to
          rely on consent or any other of the following legal bases. This, however, does not apply, whenever the
      ...
      <p>
        ...
        following purposes: Hive.
      </p>
      <p>
        Users can find further detailed information about such purposes of processing and about the specific Personal
        Data used for each purpose in the respective sections of this document.
      </p>
      <h3>Hive</h3>
      <p>
        This app connects to the Hive api, data including but not limited to your email and password are submitted to
        Hive. This allows this Service to access your Hive hardware and profile to get a list of devices, set the
        temperature of your thermostat and get the current tempearture of your thermostat.
      </p>
      <a href="https://www.hivehome.com/privacy">Hive Privacy Policy</a>
      <h2>Contact Me</h2>
      <p>If you have any questions about this Privacy Policy, please contact us. Email: thomas01155@gmail.com</p>
    </div>
  );
};
