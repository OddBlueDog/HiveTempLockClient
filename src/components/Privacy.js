  ...
  return (
    <div className="jumbotron">
      <div className="alert bg-warning">
        Please note that your password is stored as plain text, this is due to
        the way the Hive app requiers a password in plain text. Do not use this
        service if you disagree with this.
      </div>
      <h1 class="display-4">Privacy Policy</h1>
      <p>
        This page informs you of our policies regarding the collection, use and
        disclosure of Personal Information when you use our Service. We will not
      ...
      <p>
        ...
        Information”) may include, but is not limited to: email, password,
        maxTargetTemp and Temperature to set
      </p>
      <h3>Log Data</h3>
      <p>
      ...
      <p>
        ...
        guarantee its absolute security. Please remember your password is stored
        in plain text if you chose to use this service.
      </p>
      ...
      <p>
        ...
        its Services, as well as for the following purposes: Hive.
      </p>
      <p>
      ...
      <h3>Hive</h3>
      <p>
        This app connects to the Hive api, data including but not limited to
        your email and password are submitted to Hive. This allows this Service
        to access your Hive hardware and profile to get a list of devices, set
        the temperature of your thermostat and get the current tempearture of
        your thermostat.
      </p>
